...
It provides both `AWS Fargate <https://aws.amazon.com/fargate/>`_ as well as more traditional EC2 instance computing node options for the EKS Kubernetes cluster.
...
.. code-block:: shell
    ...
    cookiecutter --checkout $GITHUB_BRANCH \
                ...
                kubernetes_cluster_compute_type=EC2 \
