...
locals {
  ...
  kubernetes_name       = "${local.global_vars.locals.platform_name}-${local.global_vars.locals.platform_region}-{{ cookiecutter.global_platform_shared_resource_identifier }}"
