...
def remove_bastion():
    ...
    dir_path = os.path.join("terraform", "stacks", "{{ cookiecutter.environment_name }}", "ec2_bastion")
    rm_directory(dir_path)

    dir_path = os.path.join("terraform", "environments", "modules", "ec2_bastion")
    rm_directory(dir_path)

    dir_path = os.path.join("terraform", "environments", "{{ cookiecutter.environment_name }}", "ec2_bastion")
    rm_directory(dir_path)
